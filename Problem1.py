...
class CohortOutcomes:
    ...
    def get_overfive_percent(self):
        self._survivalresult = self._simulatedCohort.get_survival_times()
        self._count_overfive = 0
        for value in self._survivalresult:
            if value > 5:
                self._count_overfive += 1
        self._overfive = self._count_overfive / len(self._survivalresult)
        return self._overfive
...
class MultiCohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._overcutoff.append(output.get_overfive_percent())
    ...
    def get_over_cutoff_percent(self):
        return self._overcutoff
